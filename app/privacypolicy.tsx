...
export default function PrivacyPolicyScreen() {
  ...
  const pdfUrl = 'https://drive.google.com/file/d/1fS9hqMO9OUWUak1HOlhOEHhYpNRkDq0f/view?usp=drive_link';
    ...
    <SafeAreaView style={styles.container}>
      ...
      {Platform.OS === 'web' ? (
        ...
        <View style={styles.webContent}>
          ...
          <Text style={styles.webTitle}>CivicSpark Privacy Policy</Text>
          
          <Text style={styles.webDescription}>
            Our Privacy Policy explains how we collect, use, protect, and share your personal information when you use CivicSpark's platform and services.
          </Text>
          ...
          >
            ...
            <Text style={styles.openButtonText}>Open Privacy Policy</Text>
          </TouchableOpacity>
